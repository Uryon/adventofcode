...
public class Annee2023Jour16Test extends JourTest {
    private final Annee2023Jour16 jour = new Annee2023Jour16();
    private final String RESULTAT_ATTENDU_PARTIE_1 = "46";
    private final List<String> RESULTAT_INCORRECTS_PARTIE_1 = List.of();
    private final String RESULTAT_ATTENDU_PARTIE_2 = "51";
